    ...
    <div class="form-container">
        <div class="form-img">
            <form class="form-form" action="{{ route('point') }}" method="POST">
                ...
                <input id="open-map" class="btn btn-primary mt-3" type="button" value="Seleccionar ubicación">
                @php
...
@section('scripts')
    <script>
        ...
        document.getElementById('open-map').addEventListener('click', e => {
            mapC.classList.add('display-flex');
        ...
        document.getElementById('close-map').addEventListener('click', e => {
            mapC.classList.remove('display-flex');
